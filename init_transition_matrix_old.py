...
def construct_A_matrix_N( state_array=np.array([]) ):
    ...
    for var_index, var_row in enumerate(state_array.T): 
        ...
        theta_row= (calculate_theta_row(var_index, var_row_truncated, state_array_truncated))/(max(var_row))
...
A_state_transition_matrix_N = construct_A_matrix_N(X_state_matrix)
